...
public class Task1 {
    ...
    (либо HashMap, если студенты с ним знакомы). В отдельном методе нужно будет пройти по
    структуре данных, если сохранено значение ?, заменить его на соответствующее число.
    ...
    public static void main(String[] args) {
        String patch = "D:\\Учеба\\Исключения в программировании\\Seminar\\src" +
                "\\main\\java\\Seminar2\\names.txt";
